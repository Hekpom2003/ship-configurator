...
class ShipEditComponent extends React.Component {
	...
	onShipSaveAction(){
		//TODO Сохранение при изменении наверное не лучший выбор, если кто-то случайно выпилит палубу, поэтому сохраняем по кнопке.
	...
	onAddShipFloor() {
		...
		const floor = {
			...
			// id: shipFloors.length + 1, - это так не работает
			id: false,
			image: false,
			name: "Новая палуба",
			planImage: false,
			...
			<div className="ship-edit">
				...
				<div className="ship-edit__body">
					...
					<div className="ship-edit__floors">
						...
						<button onClick={this.onShipSaveAction}>Сохранить</button>
					</div>
